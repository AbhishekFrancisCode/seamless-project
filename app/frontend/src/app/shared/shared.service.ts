...
export class SharedService {
  ...
  public getBranchList() {
    return this.http.get<any>(`${environment.BASE_SERVICE_URL}/manage_branch/api/v1/BranchUser/?query=`, {})
  }
  ...
  public getDepartmentList() {
    return this.http.get<any>(`${environment.BASE_SERVICE_URL}/manage_branch/api/v1/Department/`)
  }
  ...
  public getDepartmentDetails(id) {
    return this.http.get<any>(`${environment.BASE_SERVICE_URL}/manage_branch/api/v1/Department/` + id + '/')
  }

  public saveDepartment(data) {
    return this.http.post<any>(`${environment.BASE_SERVICE_URL}/manage_branch/api/v1/Department/`, data);
  }

  public updateDepartment(data,id){
    return this.http.put<any>(`${environment.BASE_SERVICE_URL}/manage_branch/api/v1/Department/`+ id + '/', data)
  }
  ...
  public getAppSettings() {
    return this.http.get<any>(`${environment.BASE_SERVICE_URL}/manage_report/api/v1/AppSettings/`)    
  }
  public getReports() {
    return this.http.get<any>(`${environment.BASE_SERVICE_URL}/manage_report/api/v1/ReportModule/`)    
  }
   // Dashboard API's
   public getDashboardPOList() {
    return this.http.get<any>(`${environment.BASE_SERVICE_URL}/manage_dashboard/api/v1/get_po_list`)
  }
  
  public getDashboardGrnList() {
    return this.http.get<any>(`${environment.BASE_SERVICE_URL}/manage_dashboard/api/v1/get_grn_list`)
  }
  ...
  public getDashboardExpenseList() {
    return this.http.get<any>(`${environment.BASE_SERVICE_URL}/manage_dashboard/api/v1/get_monthly_expense_list`)
  }
  public getReportsNew() {
    ...
    public getReportbyIDAndType(id, from_date, to_date,filter_data) {
      return this.http.get<any>(`${environment.BASE_SERVICE_URL}/manage_reportengine/api/v1/get_report?id=${id}&from_date=${from_date}&to_date=${to_date}&filter=${filter_data}`)
    }
}
