...
export class ReportHomeComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.shareService.getAppSettings().subscribe(
      (data) =>{
        console.log(data);
        this.REPORT_CREDENTIAL.J_SERVER_URL = data[2].app_value;
          this.REPORT_CREDENTIAL.J_USER_NAME = data[1].app_value;
          this.REPORT_CREDENTIAL.J_PASSWORD = data[0].app_value;
      },
      (error) => {
