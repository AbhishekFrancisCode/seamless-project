...
class PaymentService:
    ...
    def verify_payment(self, data,):
        ...
        if self.client.utility.verify_payment_signature(param):
    ...
    @classmethod
    def verify_payment_details(cls, tran_id):
        payment_list = Payments.objects.filter(payment_order_id=tran_id).all().values(
            "id",
            'razorpay_signature',
            'razorpay_payment_id',
            'razorpay_order_id',
